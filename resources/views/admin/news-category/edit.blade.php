                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Category Name" id="name" name="name" value="{{ old('name', $category->name) }}">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Auto-generated from name" id="slug" name="slug" value="{{ old('slug', $category->slug) }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="toggle-label">
                                                <label class="toggle-switch">
                                                    <input type="checkbox" id="status" name="status" value="1" {{ old('status', $category->status) == 'active' ? 'checked' : '' }}>
                                                    <span class="toggle-slider"></span>
                                                </label>
                                                <span id="status-text">{{ old('status', $category->status) == 'active' ? 'Active' : 'Inactive' }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
