                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="News Title" id="title" name="title" value="{{ old('title', $news->title) }}">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="author_id" id="author_id">
                                                ...
                                                <option value="{{ $author->id }}" {{ old('author_id', $news->author_id) == $author->id ? 'selected' : '' }}>{{ $author->full_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="datetime-local" class="form-control" id="publish_date" name="publish_date" value="{{ old('publish_date', $news->publish_date ? $news->publish_date->format('Y-m-d\TH:i') : '') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="excerpt" name="excerpt" rows="3" placeholder="Short summary...">{{ old('excerpt', $news->excerpt) }}</textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div id="imagePreviewContainer" class="image-preview-container">
                                                ...
                                                <div class="image-preview">
                                                    <img style="width:200px" src="{{ $news->featured_image }}" alt="Current Image">
                                                </div>
                                                @endif
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="toggle-label">
                                                <label class="toggle-switch">
                                                    <input type="checkbox" id="featured" name="featured" value="1" {{ old('featured', $news->featured) ? 'checked' : '' }}>
                                                    <span class="toggle-slider"></span>
                                                </label>
                                                <span id="featured-status">{{ old('featured', $news->featured) ? 'Yes' : 'No' }}</span>
                                            </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="meta_title" name="meta_title" value="{{ old('meta_title', $news->meta_title) }}">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <textarea id="description" name="description" class="ckeditor-classic">{!! old('description', $news->description) !!}</textarea>
