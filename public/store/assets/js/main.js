...
Template Name: Bookim - Book Store HTML Template
Author:  pixel-drop
Author URI: https://themeforest.net/user/pixel-drop/portfolio
Version: 1.0.0
Description: Bookim - Book Store HTML Template  
------------------------------------------------------------------*/
/*=================================
   Index Here
==================================*/
...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $(".bd-category__click").click(function () {
      $(this)
        .siblings(
          ".category__items, .category__items-2, .category__items-3, .category__items-4"
        )
        .slideToggle();
